...
part of 'user_data_api_service.dart';
...
class _UserDataApiService implements UserDataApiService {
  _UserDataApiService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<HttpResponse<UserDataResponse>> addUserData(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<UserDataResponse>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<UserDataResponse>> getUserData(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/UserData/GetByUserCode/${userCode}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
